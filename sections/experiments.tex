...
backend against the CPU-only results from Experiments 1 and 2. This will determine if the GPU acceleration will bypass the statevector build bottleneck as Bayraktar et al. predicted \parencite{bayraktar2023cuquantum}. 
