\section{Introduction}
    ...
    on a single host Docker environment with MPI/GPU acceleration aiming to demonstrate measurable middleware speedup, shown through the GPU+MPI achievement of a 1.51x 
