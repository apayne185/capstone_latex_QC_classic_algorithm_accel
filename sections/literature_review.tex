...
the distributed subsection of the Pauli string expectation value estimations. This allows the stack to aggregate the VRAM of the entire cluster for larger chemical systems such as $BeH_{2}$ (666 Pauli terms) and $H_{2}O)$ (1086 Pauli terms) to be simulated 
